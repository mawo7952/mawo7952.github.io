...
These results are consistent with other findings identifying the largest amount of forest growth in the subalpine and upper montane regions (Rodman et al., 2019), areas furthest from the cities along the Front Range (e.g., Boulder) where the Wildland Urban Interface is currently rapidly expanding.
### References
